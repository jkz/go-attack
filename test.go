...
func defaultGame() *Game {
	...
	game.blocks[3][2] = Block{color: colorgrid.GREEN}
	game.blocks[4][2] = Block{color: colorgrid.GREEN}
	game.blocks[5][2] = Block{color: colorgrid.YELLOW}

	game.blocks[0][3] = Block{}
	game.blocks[1][3] = Block{}
	game.blocks[2][3] = Block{}
	...
	game.blocks[0][4] = Block{}
	game.blocks[1][4] = Block{}
	game.blocks[2][4] = Block{}
	game.blocks[3][4] = Block{}
	game.blocks[4][4] = Block{}
	game.blocks[5][4] = Block{}

	game.blocks[0][5] = Block{}
	game.blocks[1][5] = Block{}
	game.blocks[2][5] = Block{}
	game.blocks[3][5] = Block{}
	game.blocks[4][5] = Block{}
	game.blocks[5][5] = Block{}

	game.blocks[0][6] = Block{}
	game.blocks[1][6] = Block{}
	game.blocks[2][6] = Block{}
	game.blocks[3][6] = Block{}
	game.blocks[4][6] = Block{}
	game.blocks[5][6] = Block{}

	game.blocks[0][7] = Block{}
	game.blocks[1][7] = Block{}
	game.blocks[2][7] = Block{}
	game.blocks[3][7] = Block{}
	game.blocks[4][7] = Block{}
	game.blocks[5][7] = Block{}

	game.blocks[0][8] = Block{}
	game.blocks[1][8] = Block{}
	game.blocks[2][8] = Block{}
	game.blocks[3][8] = Block{}
	game.blocks[4][8] = Block{}
	game.blocks[5][8] = Block{}

	game.blocks[0][9] = Block{}
	game.blocks[1][9] = Block{}
	game.blocks[2][9] = Block{}
	game.blocks[3][9] = Block{}
	game.blocks[4][9] = Block{}
	game.blocks[5][9] = Block{}
...
func defaultPlayer() Player {
	...
	p.cursor.pos.y = p.game.height / 2
	p.cursor.color = colorgrid.BLACK
	return p
}
