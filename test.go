...
func defaultGame() *Game {
	...
	game.blocks[1][0] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][1] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[1][2] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][3] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[1][4] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][5] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[1][6] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][7] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[1][8] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][9] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[1][10] = Block{color: colorgrid.LIGHT_BLUE}
	...
	game.blocks[4][11] = Block{color: colorgrid.LIGHT_BLUE}
